...
from src.application.identity.handlers import handle_register
...
from src.application.session.handlers import handle_login, handle_logout, handle_refresh
...
def login(
    ...
    geo_lookup: FromDishka[GeoLookupPort],
) -> LoginResponse:
    client_ip = extract_client_ip(request)
    geo = enrich_geo_location(
        ip_address=client_ip,
        header_geo=extract_geo_metadata(request),
