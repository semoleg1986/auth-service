...
from src.application.identity.handlers import handle_block_user, handle_unblock_user
...
from src.application.session.handlers import handle_list_sessions, handle_revoke_session
