...
def init_persistence() -> None:
    """
    Инициализировать persistence инфраструктуру.

    Если задан DATABASE_URL, проверяются зависимости для SQLAlchemy.
    Создание/изменение схемы выполняется только через Alembic.
    """
